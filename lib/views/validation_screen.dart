  ...
  Future<Dashboard> scanCard() async {
    ...
    switch (response.statusCode) {
                              ...
                              Padding(
                                ...
                                child: CircleAvatar(
                                  ...
                                  backgroundImage: NetworkImage(
                                      mybody.objectValue.applicantPassportUrl),
                                ),
                              )
                            ],
                          ),
      ...
      case 400:
        ...
        break;
      case 401: Get.snackbar("Invalide", "User not found");
    }

      Get.snackbar("Invalid Candidate", "Candidate not found", colorText: Colors.white, backgroundColor: Colors.pinkAccent);
      print(response.statusCode);
